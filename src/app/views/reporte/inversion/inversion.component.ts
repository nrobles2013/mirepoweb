  ...
  ngOnInit(): void {
    ...
    this.reportesService.getReporteInversionUltimo(this.jwtAuth.user.usuario_id,this.jwtAuth.user.cparticipe).subscribe(
      (response) => {
        ...
        this.valactual=this.decimalPipe.transform(parseFloat(this.valactual), '1.2-2');
        this.valnumpar=this.decimalPipe.transform(parseFloat(this.valnumpar), '1.2-2');
        this.valortotal=this.decimalPipe.transform(parseFloat(this.valortotal), '1.2-2');
